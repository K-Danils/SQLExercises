...
import { ACTORS, DIRECTORS, GENRES, KEYWORDS, MOVIES, MOVIE_ACTORS, MOVIE_DIRECTORS, MOVIE_GENRES, MOVIE_KEYWORDS, MOVIE_PRODUCTION_COMPANIES, MOVIE_RATINGS, PRODUCTION_COMPANIES } from "../src/table-names";
...
describe("Foreign Keys", () => {
  ...
  // delete movie by id and all data from all linked tables
  it(
